...
<div class="container">
    ...
    <div class="container table-responsive">
        ...
        <thead>
            ...
            <tr>
                <?php echo form_open_multipart(base_url()."index.php/catalogos/insertFamilia/familia")?>
                ...
                <td>
                    ...
                    <a href="<?php echo base_url(). 'index.php/catalogos/index/familia/registros'; ?>" class="btn btn-danger btn-sm" >Cancelar</a>
                </td>
                <?php echo form_close();?>
            </tr>
        </table>
                ...
                <?php foreach ($registros as $registro): ?>
                    ...
                    <form action="<?php echo base_url();?>index.php/catalogos/duplicar_familia/<?php echo $catalogo?>" method="post">
                        ...
                        <?php $columnas = $this->db->list_fields($catalogo);?>
                            ...
                            <td>
                                <?php echo '<a class="btn btn-info btn-sm" data-toggle= "modal" data-target="#' . $registro->id_fam . '" role="button">Editar</a>';?>
